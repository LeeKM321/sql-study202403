...
CREATE OR REPLACE TRIGGER trg_user_insert
    ...
    FOR EACH ROW
BEGIN
    -- INSERT 예정인 name의 값에서 첫글자만 추출 후 뒤에 *을 세 개 붙이겠다.
...
INSERT INTO order_history VALUES(order_history_seq.NEXTVAL, 202, 3, 5, 25000);
